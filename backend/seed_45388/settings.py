"""
Django settings for seed_45388 project.
...
WSGI_APPLICATION = 'seed_45388.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "seed_45388 API",
    "DESCRIPTION": "API documentation for seed_45388 App",
    "VERSION": "v1",
}
